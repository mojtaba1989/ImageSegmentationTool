...
- **Paint Tool:** Allows users to use dynamic environment to draw on image when normal HSV assist is not sufficient.
...
9. **Paint Tool:** Open Paint Mask to manipulate colors and facilitate HSV parameters selection.
